                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <label for="category_name" class="col-sm-2 control-label">Category Name 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                ...
                                <b>Input Category Name</b> Max Length : 150.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/categories/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
